! function(t) {
  ...
  window.tram = function(t) {
    ...
    var F = e.frame = function() {
      ...
      N = f(function(e) {
        ...
        e.init = function(e) {
          ...
          P.backface && G.hideBackface && W(this.el, P.backface.css, "hidden")
      ...
      R = f(q, function(t, e) {
        ...
        t.init = function() {
          e.init.apply(this, arguments), this.current || (this.current = {}, J.perspective && G.perspective && (this.current.perspective = G.perspective, W(this.el, this.name, this.style(this.current)), this.redraw()))
        }, t.set = function(t) {
      ...
      B = f(U, function(t, e) {
        t.init = function(t) {
          ...
          for (e = this.tweens.length; e--;)(n = this.tweens[e])
            .context && (n.render(t), this.current[n.name] = n.value, i = !0);
    ...
    P.transform && (X.transform = [R], J = {
      ...
      skewX: [_],
      skewY: [_]
    }), P.transform && P.backface && (J.z = [x, "translateZ"], J.rotateZ = [_], J.scaleZ = [y], J.perspective = [b]);
    var Z = /ms/,
      Q = /s|\./;
    return t.tram = e
  }(window.jQuery)
  ...
  var i = n(11),
    ...
    s = function() {
      var t, e = n(31)("iframe"),
        i = o.length;
      for (e.style.display = "none", n(54)
        .appendChild(e), e.src = "javascript:", (t = e.contentWindow.document)
        .open(), t.write("<script>document.F=Object<\/script>"), t.close(), s = t.F; i--;) delete s.prototype[o[i]];
      return s()
    };
  ...
  i.define("brand", t.exports = function(t) {
    ...
    return n.ready = function() {
      ...
      /\.webflow\.io$/i.test(d) && s.hostname !== d && (u = !0), u && !c && (e = e || (n = t('<a class="w-webflow-badge"></a>')
          .attr("href", "https://webflow.com?utm_campaign=brandjs"), i = t("<img>")
          .attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon.f67cd735e3.svg")
          .css({
            marginRight: "8px",
            width: "16px"
          }), a = t("<img>")
          .attr("src", "https://d1otoma47x30pg.cloudfront.net/img/webflow-badge-text.6faa6a38cd.svg"), n.append(i, a), n[0]), h(), setTimeout(h, 500), t(r)
        .off(f, l)
        .on(f, l))
    }, n
  })
  ...
  t.exports = function() {
    ...
    return t.template = function(e, n, i) {
      ...
      var r = RegExp([(n.escape || m)
          .source, (n.interpolate || m)
          .source, (n.evaluate || m)
          .source
        ].join("|") + "|$", "g"),
        o = 0,
  ...
  n(63), n(69), n(70), n(71), t.exports = n(10)
    .Symbol
}, function(t, e, n) {
  "use strict";
  var i = n(0),
    ...
    G = function(t) {
      var e = q[t] = O(P.prototype);
      return e._k = t, e
    },
    W = R && "symbol" == typeof P.iterator ? function(t) {
    ...
    V = function(t, e, n) {
      return t === $ && V(I, e, n), y(t), e = x(e, !0), y(n), r(q, e) ? (n.enumerable ? (r(t, F) && t[F][e] && (t[F][e] = !1), n = O(n, {
        enumerable: _(0, !1)
      })) : (r(t, F) || M(t, F, _(1, {})), t[F][e] = !0), B(t, e, n)) : M(t, e, n)
    },
    Y = function(t, e) {
      y(t);
    ...
    Z = function(t) {
      for (var e, n = A(b(t)), i = [], o = 0; n.length > o;) r(q, e = n[o++]) || e == F || e == s || i.push(e);
      return i
    },
    Q = function(t) {
      for (var e, n = t === $, i = A(n ? I : b(t)), o = [], a = 0; i.length > a;) !r(q, e = i[a++]) || n && !r($, e) || o.push(q[e]);
      return o
    };
  R || (u((P = function() {
        ...
        var t = h(arguments.length > 0 ? arguments[0] : void 0),
          e = function(n) {
            this === $ && e.call(I, n), r(this, F) && r(this[F], t) && (this[F][t] = !1), B(this, t, _(1, n))
          };
        return o && H && B($, t, {
          configurable: !0,
          set: e
    ...
    .f = k.f = Z, n(26)
    .f = X, n(36)
    .f = Q, o && !n(9) && u($, "propertyIsEnumerable", X, !0), p.f = function(t) {
      return G(d(t))
    }), a(a.G + a.W + a.F * !R, {
    Symbol: P
  });
  ...
  }), P.prototype[D] || n(3)(P.prototype, D, P.prototype.valueOf), l(P, "Symbol"), l(Math, "Math", !0), l(i.JSON, "JSON", !0)
}, function(t, e, n) {
  var i = n(14)("meta"),
    r = n(8),
    o = n(1),
    ...
    return {
      ready: function() {
        ...
        e.on("click", "a", function(e) {
          if (!(i.env("design") || window.$.mobile && t(e.currentTarget)
              .hasClass("ui-link")))
                    ...
                    n.setTimeout(function() {
                      ! function(e, i) {
                        ...
                        t("body")
                          .add(e)
                          .each(function() {
                            var e = parseFloat(t(this)
                              .attr("data-scroll-time"), 10);
                            !isNaN(e) && (0 === e || e > 0) && (s = e)
  ...
  n(2)
    .define("touch", t.exports = function(t) {
      ...
      return n && (t.event.special.tap = {
        ...
        return n ? null : (e = "string" == typeof e ? t(e)
          .get(0) : e) ? new function(t) {
          var e, n, o, a = !1,
            u = !1,
            s = !1,
          ...
          function f(t) {
            var i = t.touches;
            i && i.length > 1 || (a = !0, u = !1, i ? (s = !0, e = i[0].clientX, n = i[0].clientY) : (e = t.clientX, n = t.clientY), o = e)
          }
  ...
  i.define("forms", t.exports = function(t, e) {
      ...
      return n = n || {}, e.find(':input:not([type="submit"]):not([type="file"])')
        .each(function(r, o) {
          ...
          if ("checkbox" === u) c = a.is(":checked");
            ...
            c = e.find('input[name="' + a.attr("name") + '"]:checked')
              .val() || null
          }
    ...
    return s.ready = s.design = s.preview = function() {
      ! function() {
        r = t("html")
          .attr("data-wf-site"), a = "https://webflow.com/api/v1/form/" + r, l && a.indexOf("https://webflow.com") >= 0 && (a = a.replace("https://webflow.com", "http://formdata.webflow.com"));
        if (u = a + "/signFile", !(n = t(h + " form"))
          .length) return;
        n.each(w)
  ...
  i.define("navbar", t.exports = function(t, e) {
    ...
    function _(n, r) {
      ...
      s || (s = t.data(r, p, {
        ...
        return function(n) {
          var i = t(n.target);
          u && i.closest(".w-editor-bem-EditorOverlay")
            .length || j(e, i)
        }
        ...
        return function(n, i) {
          i = i || {};
          var r = f.width();
          S(t), !0 === i.open && A(t, !0), !1 === i.open && L(t, !0), t.open && e.defer(function() {
            r !== f.width() && E(t)
          })
        }
      }(s))) : (! function(e) {
        if (e.overlay) return;
        e.overlay = t(d)
          .appendTo(e.el), e.parent = e.menu.parent(), L(e, !0)
    ...
    s.ready = s.design = s.preview = function() {
      if (a = h && i.env("design"), u = i.env("editor"), n = t(document.body), !(o = l.find(p))
        .length) return;
      ...
      if (!t.open) {
        ...
        if (T(0, f), y.intro(0, f), i.redraw.up(), a || l.on("tap" + p, t.outside), !e) {
          ...
          if (t.overlay && (w = t.menu.prev(), t.overlay.show()
              .append(t.menu)), n.animOver) return c(t.menu)
            .add(h)
            .set({
              x: n.animDirect * u,
              height: r
    ...
    function L(t, e) {
      if (t.open) {
        ...
        var n = t.config;
        if (("none" === n.animation || !c.support.transform || n.duration <= 0) && (e = !0), y.outro(0, t.el[0]), l.off("tap" + p, t.outside), e) return c(t.menu)
          .stop(), void s();
        var i = "transform " + n.duration + "ms " + n.easing2,
          r = t.menu.outerHeight(!0),
          o = t.menu.outerWidth(!0),
          a = t.el.height();
        if (n.animOver) c(t.menu)
          .add(i)
          .start({
            x: o * n.animDirect
          })
      ...
      function s() {
        t.menu.height(""), c(t.menu)
          .set({
            x: 0,
            y: 0
          }), t.menu.removeClass(m), t.links.removeClass(g), t.overlay && t.overlay.children()
  ...
  var i = window.jQuery,
    ...
    a = {
      ...
      intro: function(t, e) {
        e.__wf_intro || (e.__wf_intro = !0, i(e)
          .triggerHandler(r.types.INTRO))
      },
      outro: function(t, e) {
        e.__wf_intro && (e.__wf_intro = null, i(e)
          .triggerHandler(r.types.OUTRO))
      }
    };
  r.triggers = {}, r.types = {
    INTRO: "w-ix-intro.w-ix",
